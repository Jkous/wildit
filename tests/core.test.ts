...
describe('random core', () => {
  ...
  test('consistent random with same seed', () => {
    const seed = 67890
    const random1 = new RandomValues(seed)
    const random2 = new RandomValues(seed)
  ...
  test('different seeds produce different sequences', () => {
    const random1 = new RandomValues(11111)
    const random2 = new RandomValues(22222)
  ...
  test('random values are within expected range', () => {
    const random = new RandomValues(54321)
  ...
  test('random function is callable', () => {
    const random = new RandomValues(13579)
  ...
  test('RandomValues class instantiation', () => {
    expect(() => new RandomValues(24680)).not.toThrow()
  })
  ...
  test('RandomValues handles zero seed value', () => {
    const random = new RandomValues(0)
  ...
  test('RandomValues handles large seed values', () => {
    const random = new RandomValues(1e12)
  ...
  test('RandomValues handles non-integer seed values', () => {
    const random = new RandomValues(123.456)
  ...
  test('RandomValues handles very small seed values', () => {
    const random = new RandomValues(1e-10)
