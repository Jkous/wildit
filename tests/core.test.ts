...
import createRandomValues from '../src'

describe('random core', () => {
  test('basic random', () => {
    const random = createRandomValues(12345)
  ...
  test('consistent random with same seed', () => {
    const seed = 67890
    const random1 = createRandomValues(seed)
    const random2 = createRandomValues(seed)
  ...
  test('different seeds produce different sequences', () => {
    const random1 = createRandomValues(11111)
    const random2 = createRandomValues(22222)
  ...
  test('random values are within expected range', () => {
    const random = createRandomValues(54321)
  ...
  test('random function is callable', () => {
    const random = createRandomValues(13579)
  ...
  test('RandomValues class instantiation', () => {
    expect(() => createRandomValues(24680)).not.toThrow()
  })
  ...
  test('RandomValues handles zero seed value', () => {
    const random = createRandomValues(0)
  ...
  test('RandomValues handles large seed values', () => {
    const random = createRandomValues(1e12)
  ...
  test('RandomValues handles non-integer seed values', () => {
    const random = createRandomValues(123.456)
  ...
  test('RandomValues handles very small seed values', () => {
    const random = createRandomValues(1e-10)
